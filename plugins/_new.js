let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `BASANZIE 𝐓𝐄𝐂𝐇 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍E𝐋𝐄 𝐅𝐎𝐋𝐋𝐎𝐖 𝐑𝐄𝐐_\n *𝐋𝐈𝐍𝐊:* https://whatsapp.com/channel/0029VaJX1NzCxoAyVGHlfY2l\n\n ${Config.botname} *WORKS*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `SHAKIRA 𝐌𝐃 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://whatsapp.com/channel/0029VaJX1NzCxoAyVGHlfY2l \n\n ${Config.botname} *WORKS*`;
 ...
 let tmpUrl = "https://telegra.ph/file/e11bafaedba6aebcd9410.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
